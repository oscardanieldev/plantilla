...
<body>
    ...
    <div id="app">
        ...
        <nav id="barra" class="nav-extended">
            <div class="nav-wrapper container-fluid"  >
              ...
              <ul class="right hide-on-med-and-down">
                ...
                <li><a class="waves-effect waves-light" href="{{route('cursos.index')}}">Cursos</a></li>
                <li><a class="waves-effect waves-light" href="{{route('talleres.index')}}">Talleres</a></li>
          ...
          <ul class="sidenav" id="mobile-demo">
            <a href="/"><h5 class="container py-2 center-align border-f black-text">Escuela de Inglés</h5></a>
            <li><a class="waves-effect " href="{{route('cursos.index')}}">Cursos</a></li>
            <li><a class="waves-effect " href="{{route('talleres.index')}}">Talleres</a></li>
            ...
            @yield('footer')
                <footer class="blue-grey lighten-4 py-2">
                    <div class="center-align">
                        ...
                        <a class="red-text  text-darken-3 px-1" href="#"><i class="redes-sociales fab fa-google-plus-g"></i></a>
                    </div>
                    <div class="center-align">
